...
export default function CounsellorCalendarPage() {
  ...
  const appointments = [
    {
      id: 1,
      title: "Initial counselling - Michael Brown",
  ...
  return (
    <DashboardLayout userType="hr" userName="Durva">
 ...
 <Button
  ...
  className="gap-2"
  onClick={() => {
    // Navigate to view all appointments page
    window.location.href = "/dashboard/hr/calendar/all";
  }}
>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="counselling">Initial counselling</SelectItem>
